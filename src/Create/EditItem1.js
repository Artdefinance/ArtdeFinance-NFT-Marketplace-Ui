  ...
  return (
    <div className="create">
      <div className="create__wrap">
        <h3 className="create__title">Edit item</h3>
        <div className="create__content">
          <div className="create__content-inner">
            <InputTitle required help>Item Image</InputTitle>
            <Alert type="primary">Please upload Images of your item.</Alert>
            <FileDragDrop
              boxTypeClass="drag-drop-create"
            ...
            <InputTitle required>Item Title</InputTitle>
            ...
            <InputTitle required>Collection</InputTitle>
            <Dropdown
              dropClass="rota-24"
              dropHeight="40px"
              dropTitle="Please select a collection."
              content={options}
              defaultSelectedId="1"
            />
