  ...
  render() {
    ...
    const d = (() => {
      ...
      if (shape === 'external-link') {
        return 'M14.25 14.2498H3.75V3.74976H9V2.24976H3.75C2.9175 2.24976 2.25 2.92476 2.25 3.74976V14.2498C2.25 15.0748 2.9175 15.7498 3.75 15.7498H14.25C15.075 15.7498 15.75 15.0748 15.75 14.2498V8.99976H14.25V14.2498ZM10.5 2.24976V3.74976H13.1925L5.82 11.1223L6.8775 12.1798L14.25 4.80726V7.49976H15.75V2.24976H10.5Z';
      }
      if (shape === 'copy-all') {
        return 'M13.875 1.5H7.125C6.3 1.5 5.625 2.175 5.625 3V12C5.625 12.825 6.3 13.5 7.125 13.5H13.875C14.7 13.5 15.375 12.825 15.375 12V3C15.375 2.175 14.7 1.5 13.875 1.5ZM13.875 12H7.125V3H13.875V12ZM2.625 11.25V9.75H4.125V11.25H2.625ZM2.625 7.125H4.125V8.625H2.625V7.125ZM7.875 15H9.375V16.5H7.875V15ZM2.625 13.875V12.375H4.125V13.875H2.625ZM4.125 16.5C3.3 16.5 2.625 15.825 2.625 15H4.125V16.5ZM6.75 16.5H5.25V15H6.75V16.5ZM10.5 16.5V15H12C12 15.825 11.325 16.5 10.5 16.5ZM4.125 4.5V6H2.625C2.625 5.175 3.3 4.5 4.125 4.5Z';
      }
      if (shape === 'shipping') {
        return 'M16.6673 6.66732H14.1673V3.33398H2.50065C1.58398 3.33398 0.833984 4.08398 0.833984 5.00065V14.1673H2.50065C2.50065 15.5507 3.61732 16.6673 5.00065 16.6673C6.38398 16.6673 7.50065 15.5507 7.50065 14.1673H12.5007C12.5007 15.5507 13.6173 16.6673 15.0006 16.6673C16.384 16.6673 17.5006 15.5507 17.5006 14.1673H19.1673V10.0007L16.6673 6.66732ZM16.2506 7.91732L17.884 10.0007H14.1673V7.91732H16.2506ZM5.00065 15.0007C4.54232 15.0007 4.16732 14.6257 4.16732 14.1673C4.16732 13.709 4.54232 13.334 5.00065 13.334C5.45898 13.334 5.83398 13.709 5.83398 14.1673C5.83398 14.6257 5.45898 15.0007 5.00065 15.0007ZM6.85065 12.5007C6.39232 11.9923 5.74232 11.6673 5.00065 11.6673C4.25898 11.6673 3.60898 11.9923 3.15065 12.5007H2.50065V5.00065H12.5007V12.5007H6.85065ZM15.0006 15.0007C14.5423 15.0007 14.1673 14.6257 14.1673 14.1673C14.1673 13.709 14.5423 13.334 15.0006 13.334C15.459 13.334 15.834 13.709 15.834 14.1673C15.834 14.6257 15.459 15.0007 15.0006 15.0007Z';
      }
      return 'M19 6.41L17.59 5L12 10.59L6.41 5L5 6.41L10.59 12L5 17.59L6.41 19L12 13.41L17.59 19L19 17.59L13.41 12L19 6.41Z';
    })();
    return (
          ...
          {(() => {
            if (shape === 'notice') {
              return (
                <>
                  <path
                    d="M11.5536 3H12.4464C16.0593 3 19 5.96296 19 9.60317V17H5V9.60317C5 5.96296 7.94073 3 11.5536 3V3Z"
                    stroke="#555555"
                    strokeWidth="2"
                  ...
                  />
                  <path
                    d="M14.8456 17C14.9515 17.3107 14.9985 17.6343 14.9985 17.9579C14.9985 19.6408 13.6574 21 11.9985 21C10.3397 21 8.99854 19.6408 8.99854 17.9579C8.99854 17.6214 9.04559 17.2977 9.15148 17"
                    stroke="#555555"
                    strokeWidth="2"
                    strokeLinecap="round"
                    strokeLinejoin="round"
              ...
              return (
                <>
                  ...
                  <path
                    fillRule="evenodd"
                    clipRule="evenodd"
                    d="M17 2H7V6H3V8H5V22H19V8H21V6H17V2ZM15 6V4H9V6H15ZM7 8V20H17V8H7Z"
                    fill={color}
                  />
                </>
              );
            ...
            if (shape === 'share') {
              return (
                <>
                  <path
                    d="M12 4H4C3.44772 4 3 4.44772 3 5V19C3 19.5523 3.44772 20 4 20H12"
                    stroke="#555555"
                    strokeWidth="2"
                  />
                  <path
                    d="M7 12H20M20 12L15.5 7.5M20 12L15.5 16.5"
                    stroke="#555555"
                    strokeWidth="2"
                  />
                </>
            ...
            if (shape === 'exclama') {
              return (
                <>
                  <path
                    d="M11.9577 3C7.0185 3 3 7.0374 3 12C3 16.9626 7.0374 21 12 21C16.9626 21 21 16.9626 21 12C21 7.0374 16.9437 3 11.9577 3ZM12 19.2C8.0301 19.2 4.8 15.9699 4.8 12C4.8 8.0301 8.0103 4.8 11.9577 4.8C15.9519 4.8 19.2 8.0301 19.2 12C19.2 15.9699 15.9699 19.2 12 19.2Z"
                    fill={color}
                  />
                  <path
                    d="M11.0996 7.5H12.8996V13.8H11.0996V7.5ZM11.0996 14.7H12.8996V16.5H11.0996V14.7Z"
                    fill={color}
                  />
                </>
              );
            ...
            if (shape === 'checkbox_fill') {
              return (
                <>
                  <path
                    d="M12 3C7.0374 3 3 7.0374 3 12C3 16.9626 7.0374 21 12 21C16.9626 21 21 16.9626 21 12C21 7.0374 16.9626 3 12 3ZM12 19.2C8.0301 19.2 4.8 15.9699 4.8 12C4.8 8.0301 8.0301 4.8 12 4.8C15.9699 4.8 19.2 8.0301 19.2 12C19.2 15.9699 15.9699 19.2 12 19.2Z"
                    fill="#15A46E"
                  />
                  <path
                    d="M10.1993 13.4284L8.13017 11.3629L6.85938 12.6373L10.2011 15.9718L16.2365 9.93636L14.9639 8.66376L10.1993 13.4284Z"
                    fill="#15A46E"
                  />
                </>
              );
            ...
            if (shape === 'alram') {
              return (
                <>
                  <path
                    d="M12 4C7.121 4 3 8.121 3 13C3 17.879 7.121 22 12 22C16.879 22 21 17.879 21 13C21 8.121 16.879 4 12 4ZM12 20C8.206 20 5 16.794 5 13C5 9.206 8.206 6 12 6C15.794 6 19 9.206 19 13C19 16.794 15.794 20 12 20Z"
                    fill="#555555"
                  />
                  <path
                    d="M13 12V7.99999H11V14H17V12H13ZM17.284 3.70699L18.696 2.29099L21.706 5.29099L20.293 6.70799L17.284 3.70699ZM6.69804 3.70699L3.70804 6.70599L2.29004 5.29399L5.28004 2.29399L6.69804 3.70699Z"
                    fill="#555555"
                  />
                </>
              );
            ...
            if (shape === 'calendar') {
              return (
                <>
                  ...
                  <path
                    d="M10.75 9.375H13.25V11.875H10.75V9.375Z"
                    fill="#555555"
                  />
                  <path
                    d="M13.25 14.125H10.75V16.625H13.25V14.125Z"
                    fill="#555555"
                  />
                  ...
                  <path
                    fillRule="evenodd"
                    clipRule="evenodd"
                    d="M5 5H2V21H22V5H19V2H17V5H7V2H5V5ZM4 7V19H20V7H4Z"
                    fill="#555555"
                  />
                </>
              );
            ...
            if (shape === 'data') {
              return (
                <>
                  <path
                    d="M16.6668 5.00002C16.6668 3.19335 13.6143 1.66669 10.0002 1.66669C6.386 1.66669 3.3335 3.19335 3.3335 5.00002V6.66669C3.3335 8.47335 6.386 10 10.0002 10C13.6143 10 16.6668 8.47335 16.6668 6.66669V5.00002ZM10.0002 15.8334C6.386 15.8334 3.3335 14.3067 3.3335 12.5V15C3.3335 16.8067 6.386 18.3334 10.0002 18.3334C13.6143 18.3334 16.6668 16.8067 16.6668 15V12.5C16.6668 14.3067 13.6143 15.8334 10.0002 15.8334Z"
                    fill="#BBBBBB"
                  />
                  <path
                    d="M16.6668 8.33331C16.6668 10.14 13.6143 11.6666 10.0002 11.6666C6.386 11.6666 3.3335 10.14 3.3335 8.33331V10.8333C3.3335 12.64 6.386 14.1666 10.0002 14.1666C13.6143 14.1666 16.6668 12.64 16.6668 10.8333V8.33331Z"
                    fill="#BBBBBB"
                  />
                </>
              );
            ...
            if (shape === 'data-small') {
              return (
                <>
                  <path
                    d="M15 4.5C15 2.874 12.2528 1.5 9 1.5C5.74725 1.5 3 2.874 3 4.5V6C3 7.626 5.74725 9 9 9C12.2528 9 15 7.626 15 6V4.5ZM9 14.25C5.74725 14.25 3 12.876 3 11.25V13.5C3 15.126 5.74725 16.5 9 16.5C12.2528 16.5 15 15.126 15 13.5V11.25C15 12.876 12.2528 14.25 9 14.25Z"
                    fill="#BBBBBB"
                  />
                  <path
                    d="M15 7.5C15 9.126 12.2528 10.5 9 10.5C5.74725 10.5 3 9.126 3 7.5V9.75C3 11.376 5.74725 12.75 9 12.75C12.2528 12.75 15 11.376 15 9.75V7.5Z"
                    fill="#BBBBBB"
                  />
                </>
              );
            ...
            if (shape === 'data-small--gray') {
              return (
                <>
                  <path
                    d="M17.6755 5.00033C17.6755 3.19366 14.554 1.66699 10.8582 1.66699C7.16245 1.66699 4.04102 3.19366 4.04102 5.00033V6.66699C4.04102 8.47366 7.16245 10.0003 10.8582 10.0003C14.554 10.0003 17.6755 8.47366 17.6755 6.66699V5.00033ZM10.8582 15.8337C7.16245 15.8337 4.04102 14.307 4.04102 12.5003V15.0003C4.04102 16.807 7.16245 18.3337 10.8582 18.3337C14.554 18.3337 17.6755 16.807 17.6755 15.0003V12.5003C17.6755 14.307 14.554 15.8337 10.8582 15.8337Z"
                    fill="#DDDDDD"
                  />
                  <path
                    d="M17.6755 8.33301C17.6755 10.1397 14.554 11.6663 10.8582 11.6663C7.16245 11.6663 4.04102 10.1397 4.04102 8.33301V10.833C4.04102 12.6397 7.16245 14.1663 10.8582 14.1663C14.554 14.1663 17.6755 12.6397 17.6755 10.833V8.33301Z"
                    fill="#DDDDDD"
                  />
                </>
              );
            ...
            if (shape === 'camera') {
              return (
                <>
                  ...
                  />
                  <path
                    d="M19 22C20.2426 22 21.25 20.9926 21.25 19.75C21.25 18.5074 20.2426 17.5 19 17.5C17.7574 17.5 16.75 18.5074 16.75 19.75C16.75 20.9926 17.7574 22 19 22Z"
                    fill="white"
                  />
                  <path
                    d="M16.75 12.25L15.3775 13.75H11.5V25.75H26.5V13.75H22.6225L21.25 12.25H16.75ZM19 23.5C16.93 23.5 15.25 21.82 15.25 19.75C15.25 17.68 16.93 16 19 16C21.07 16 22.75 17.68 22.75 19.75C22.75 21.82 21.07 23.5 19 23.5Z"
                    fill="white"
                  />
                </>
              );
            ...
            if (shape === 'pencil') {
              return (
                <>
                  ...
                  />
                  <path
                    d="M12.0962 23.0913V25.9038H14.9087L23.2037 17.6088L20.3912 14.7963L12.0962 23.0913ZM25.9037 14.9088L23.0912 12.0963L21.1937 14.0013L24.0062 16.8138L25.9037 14.9088Z"
                    fill="white"
                  />
                </>
              );
            ...
            if (shape === 'home') {
              return (
                <>
                  ...
                  <path
                    d="M19.1668 27.7916V22.2916H22.8335V27.7916H27.4168V20.4583H30.1668L21.0002 12.2083L11.8335 20.4583H14.5835V27.7916H19.1668Z"
                    fill="black"
                  />
                  <defs>
                    <filter
                      id="filter0_d_372_8491"
                      x="0"
                      y="0"
                      width="42"
                      height="42"
                    ...
                    >
                      ...
                      <feColorMatrix
                        type="matrix"
                        values="0 0 0 0 0.471012 0 0 0 0 0.471012 0 0 0 0 0.471012 0 0 0 0.15 0"
                      />
                      <feBlend
                        mode="normal"
                        in2="BackgroundImageFix"
                        result="effect1_dropShadow_372_8491"
                      />
                      <feBlend
                        mode="normal"
                        in="SourceGraphic"
                        in2="effect1_dropShadow_372_8491"
                        result="shape"
                      />
                    </filter>
                  </defs>
            ...
            if (shape === 'download') {
              return (
                <>
                  <path
                    d="M4 14.5V19.5C4 20.0523 4.44772 20.5 5 20.5H19C19.5523 20.5 20 20.0523 20 19.5V14.5"
                    stroke="#555555"
                    strokeWidth="2"
                  />
                  <path
                    d="M12 3V16M12 16L7.5 11.5M12 16L16.5 11.5"
                    stroke="#555555"
                    strokeWidth="2"
                  />
                </>
            ...
            if (shape === 'arrow-left') {
              return (
                <path
                  d="M9.41437 11.9999L16.4144 4.9999L15.0002 3.58569L6.58594 11.9999L15.0002 20.4141L16.4144 18.9999L9.41437 11.9999Z"
                  fill="black"
                />
              );
            }
            if (shape === 'arrow-right') {
              return (
                <path
                  d="M7.91797 15.333L12.418 10.583L7.91797 5.83301"
                  stroke="#BBBBBB"
                />
              );
            }
            if (shape === 'arrow-up') {
              return (
                <path
                  d="M7.78656 15.41L12.6105 10.83L17.4345 15.41L18.9163 14L12.6105 8L6.30469 14L7.78656 15.41Z"
                  fill="#888888"
                />
              );
            }
            if (shape === 'arrow-down') {
              return (
                <path
                  d="M7.78656 9L12.6105 13.58L17.4345 9L18.9163 10.41L12.6105 16.41L6.30469 10.41L7.78656 9Z"
                  fill="#888888"
                />
              );
            }
            ...
            if (shape === 'close-circle-bk') {
              return (
                <path
                  d="M12 3C7.0374 3 3 7.0374 3 12C3 16.9626 7.0374 21 12 21C16.9626 21 21 16.9626 21 12C21 7.0374 16.9626 3 12 3ZM15.7863 14.5137L14.5137 15.7863L12 13.2726L9.4863 15.7863L8.2137 14.5137L10.7274 12L8.2137 9.4863L9.4863 8.2137L12 10.7274L14.5137 8.2137L15.7863 9.4863L13.2726 12L15.7863 14.5137Z"
                  fill="black"
                />
              );
            }
                ...
                >
                  <g clipPath="url(#clip0_801_15774)">
                    ...
                    <path
                      fillRule="evenodd"
                      clipRule="evenodd"
                      d="M4.59583 5.96759L8.00386 2.55957L9.36272 3.91843L5.95471 7.32647L4.59583 5.96759ZM4.59832 10.0401L10.0446 4.59371L11.4035 5.95259L5.95719 11.3989L4.59832 10.0401ZM12.0816 6.6345L6.63524 12.0808L7.9941 13.4397L13.4404 7.99336L12.0816 6.6345ZM2.56055 8.00245L3.91941 6.64357L5.27829 8.00245L3.91941 9.36131L2.56055 8.00245Z"
                      fill="white"
                    />
                  </g>
                  <defs>
            ...
            if (shape === 'adf') {
              return (
                <>
                  <path
                    d="M10.2852 20C15.808 20 20.2852 15.5228 20.2852 10C20.2852 4.47715 15.808 0 10.2852 0C4.76231 0 0.285156 4.47715 0.285156 10C0.285156 15.5228 4.76231 20 10.2852 20Z"
                    fill="black"
                  />
                  <path
                    d="M16.6276 9.22267V10.8036H11.6942V14.429H10.1133V7.14648H11.6942V9.22267H16.6276Z"
                    fill="white"
                  />
                  <path
                    d="M16.6247 5.56641H11.6914V7.14736H16.6247V5.56641Z"
                    fill="white"
                  />
                  <path
                    d="M6.43567 5.56641L3.95312 14.4299H5.52773L6.5436 10.8109H8.00392V7.14101H10.1119V5.56641H6.43567Z"
                    fill="white"
                  />
                </>
              );
            ...
            if (shape === 'bnb') {
              return (
                <>
                  <path
                    d="M19.9798 12.419C18.6442 17.7762 13.2183 21.0365 7.86044 19.7006C2.50486 18.365 -0.755423 12.9387 0.580735 7.58197C1.91572 2.22419 7.34169 -1.03634 12.6979 0.299234C18.0553 1.63481 21.3154 7.0617 19.9797 12.4191L19.9798 12.419H19.9798Z"
                    fill="#F3BA2F"
                  />
                  <path
                    fillRule="evenodd"
                    clipRule="evenodd"
                    d="M10.2799 6.34732L7.69051 8.93676L7.69056 8.93665L6.18395 7.42998L10.2799 3.33398L14.3773 7.43121L12.8706 8.93788L10.2799 6.34732ZM5.12 8.49372L3.61328 10.0007L5.11989 11.5071L6.62662 10.0003L5.12 8.49372ZM7.69051 11.0647L10.2799 13.654L12.8706 11.0635L14.378 12.5693L14.3773 12.5701L10.2799 16.6673L6.18395 12.5713L6.18182 12.5692L7.69051 11.0647ZM15.44 8.49457L13.9333 10.0013L15.4399 11.5079L16.9466 10.0012L15.44 8.49457Z"
                    fill="white"
                  />
                  <path
                    d="M11.8078 9.99956H11.8084L10.2797 8.4707L9.14968 9.60036V9.60036L9.01987 9.73022L8.75213 9.99801L8.75 10.0001L8.75213 10.0023L10.2797 11.53L11.8085 10.0012L11.8093 10.0003L11.8079 9.99956"
                    fill="white"
                  />
                </>
              );
              ...
              return (
                <>
                  <g clipPath="url(#clip0_491_20929)">
                    ...
                    <path
                      d="M10.5078 3L12.1755 4.70783L7.97624 8.90707L6.30859 7.23943L10.5078 3Z"
                      fill="white"
                      stroke="#F0B90B"
                    />
                    <path
                      d="M13.0394 5.5332L14.7071 7.24103L7.97624 13.9719L6.30859 12.3042L13.0394 5.5332Z"
                      fill="white"
                      stroke="#F0B90B"
                    />
                    <path
                      d="M5.44889 8.0625L7.11653 9.77033L5.44889 11.438L3.78125 9.77033L5.44889 8.0625Z"
                      fill="white"
                      stroke="#F0B90B"
                    />
                    <path
                      d="M15.5785 8.0625L17.2461 9.77033L10.5153 16.5012L8.84766 14.8335L15.5785 8.0625Z"
                      fill="white"
                      stroke="#F0B90B"
                    />
                  </g>
            ...
            if (shape === 'carousel_prev') {
              return (
                <>
                  ...
                  />
                  <path
                    d="M19.0002 23L20.4102 21.59L15.8302 17L20.4102 12.41L19.0002 11L13.0002 17L19.0002 23Z"
                    fill="black"
                  />
                </>
              );
            ...
            if (shape === 'carousel_next') {
              return (
                <>
                  ...
                  <path
                    d="M14.8983 11L13.4883 12.41L18.0683 17L13.4883 21.59L14.8983 23L20.8983 17L14.8983 11Z"
                    fill="black"
                  />
                </>
              );
            ...
            if (shape === 'binance') {
              return (
                <>
                  ...
                  />
                  <path
                    d="M6.64173 2.35303L7.73351 3.52861L4.98435 6.41918L3.89258 5.27125L6.64173 2.35303Z"
                    fill="white"
                    stroke="white"
                  />
                  <path
                    d="M8.29911 4.0957L9.39088 5.27129L4.98435 9.90449L3.89258 8.75656L8.29911 4.0957Z"
                    fill="white"
                    stroke="white"
                  />
                  <path
                    d="M3.32615 5.83838L4.41792 7.01397L3.32615 8.1619L2.23438 7.01397L3.32615 5.83838Z"
                    fill="white"
                    stroke="white"
                  />
                  <path
                    d="M9.95536 5.83838L11.0471 7.01397L6.6406 11.6472L5.54883 10.4992L9.95536 5.83838Z"
                    fill="white"
                    stroke="white"
                  />
                </>
            ...
            if (shape === 'eth') {
              return (
                <>
                  <path d="M5.9983 0L5.86719 0.445348V13.3672L5.9983 13.498L11.9964 9.95249L5.9983 0Z" fill="#343434" />
                  <path d="M5.9982 0L0 9.95249L5.9982 13.498V7.22609V0Z" fill="#8C8C8C" />
                  <path d="M5.9987 14.6335L5.9248 14.7236V19.3266L5.9987 19.5423L12.0004 11.0898L5.9987 14.6335Z" fill="#3C3C3B" />
                  <path d="M5.9982 19.5423V14.6335L0 11.0898L5.9982 19.5423Z" fill="#8C8C8C" />
                  <path d="M5.99805 13.4982L11.9961 9.95272L5.99805 7.22632V13.4982Z" fill="#141414" />
                  <path d="M0 9.95272L5.9982 13.4982V7.22632L0 9.95272Z" fill="#393939" />
                </>
              );
            }
            if (shape === 'matic') {
              return (
                <path d="M10.8251 4.27893C10.5693 4.11276 10.2403 4.11276 9.94785 4.27893L7.90085 5.64985L6.51182 6.52225L4.50137 7.89317C4.2455 8.05935 3.91652 8.05935 3.62409 7.89317L2.05229 6.81306C1.79641 6.64688 1.61364 6.31454 1.61364 5.94065V3.8635C1.61364 3.53116 1.75986 3.19881 2.05229 2.9911L3.62409 1.95252C3.87996 1.78635 4.20894 1.78635 4.50137 1.95252L6.07317 3.03264C6.32905 3.19881 6.51182 3.53116 6.51182 3.90504V5.27596L7.90085 4.36202V2.94955C7.90085 2.61721 7.75464 2.28487 7.46221 2.07715L4.53793 0.124629C4.28205 -0.041543 3.95307 -0.041543 3.66064 0.124629L0.663252 2.11869C0.370823 2.28487 0.224609 2.61721 0.224609 2.94955V6.8546C0.224609 7.18694 0.370823 7.51929 0.663252 7.727L3.62409 9.67953C3.87996 9.8457 4.20894 9.8457 4.50137 9.67953L6.51182 8.35015L7.90085 7.4362L9.91129 6.10682C10.1672 5.94065 10.4962 5.94065 10.7886 6.10682L12.3604 7.1454C12.6163 7.31157 12.799 7.64392 12.799 8.0178V10.095C12.799 10.4273 12.6528 10.7596 12.3604 10.9674L10.8251 12.0059C10.5693 12.1721 10.2403 12.1721 9.94785 12.0059L8.37605 10.9674C8.12017 10.8012 7.9374 10.4688 7.9374 10.095V8.76558L6.54837 9.67953V11.0504C6.54837 11.3828 6.69458 11.7151 6.98701 11.9228L9.94785 13.8754C10.2037 14.0415 10.5327 14.0415 10.8251 13.8754L13.786 11.9228C14.0418 11.7567 14.2246 11.4243 14.2246 11.0504V7.10386C14.2246 6.77151 14.0784 6.43917 13.786 6.23145L10.8251 4.27893Z" fill="#8247E5" />
              );
            }
            if (shape === 'user-eth') {
              return (
                <>
                  <path d="M4.29803 0L4.2041 0.319045V9.57618L4.29803 9.66989L8.595 7.12991L4.29803 0Z" fill="#343434" />
                  <path d="M4.29708 0L0 7.12991L4.29708 9.66989V5.17673V0Z" fill="#8C8C8C" />
                  <path d="M4.29708 10.483L4.24414 10.5476V13.8451L4.29708 13.9996L8.59668 7.94434L4.29708 10.483Z" fill="#3C3C3B" />
                  <path d="M4.29708 13.9996V10.483L0 7.94434L4.29708 13.9996Z" fill="#8C8C8C" />
                  <path d="M4.29688 9.66992L8.59385 7.12994L4.29688 5.17676V9.66992Z" fill="#141414" />
                  <path d="M0 7.12994L4.29708 9.66992V5.17676L0 7.12994Z" fill="#393939" />
                </>
              );
            }
            ...
            if (shape === 'user-matic') {
              return (
                <path d="M9.08616 3.66766C8.86684 3.52522 8.58486 3.52522 8.3342 3.66766L6.57963 4.84273L5.38903 5.5905L3.6658 6.76558C3.44648 6.90801 3.16449 6.90801 2.91384 6.76558L1.56658 5.83976C1.34726 5.69733 1.1906 5.41246 1.1906 5.09199V3.31157C1.1906 3.02671 1.31593 2.74184 1.56658 2.5638L2.91384 1.67359C3.13316 1.53116 3.41514 1.53116 3.6658 1.67359L5.01305 2.59941C5.23238 2.74184 5.38903 3.02671 5.38903 3.34718V4.52226L6.57963 3.73887V2.52819C6.57963 2.24332 6.45431 1.95846 6.20366 1.78042L3.69713 0.106825C3.47781 -0.0356083 3.19582 -0.0356083 2.94517 0.106825L0.375979 1.81602C0.125326 1.95846 0 2.24332 0 2.52819V5.87537C0 6.16024 0.125326 6.4451 0.375979 6.62315L2.91384 8.29674C3.13316 8.43917 3.41514 8.43917 3.6658 8.29674L5.38903 7.15727L6.57963 6.37389L8.30287 5.23442C8.52219 5.09199 8.80418 5.09199 9.05483 5.23442L10.4021 6.12463C10.6214 6.26706 10.7781 6.55193 10.7781 6.8724V8.65282C10.7781 8.93769 10.6527 9.22255 10.4021 9.40059L9.08616 10.2908C8.86684 10.4332 8.58486 10.4332 8.3342 10.2908L6.98695 9.40059C6.76762 9.25816 6.61097 8.97329 6.61097 8.65282V7.51335L5.42037 8.29674V9.47181C5.42037 9.75668 5.54569 10.0415 5.79634 10.2196L8.3342 11.8932C8.55353 12.0356 8.83551 12.0356 9.08616 11.8932L11.624 10.2196C11.8433 10.0772 12 9.79228 12 9.47181V6.08902C12 5.80415 11.8747 5.51929 11.624 5.34125L9.08616 3.66766Z" fill="#8247E5" />
              );
            }
            ...
            if (shape === 'user-bnb') {
              return (
                <>
                  <path d="M13.789 8.69333C12.8541 12.4434 9.05592 14.7256 5.30544 13.7904C1.55653 12.8555 -0.725671 9.05711 0.20964 5.30738C1.14413 1.55693 4.94231 -0.725437 8.69163 0.209464C12.4418 1.14436 14.7239 4.94319 13.7889 8.6934L13.789 8.69333H13.789Z" fill="#F3BA2F" />
                  <path fillRule="evenodd" clipRule="evenodd" d="M7.00016 4.44234L5.1876 6.25488L4.13297 5.20021L7.00016 2.33301L9.8683 5.20107L8.81363 6.25573L7.00016 4.44234ZM3.3882 5.94482L2.3335 6.99967L3.38813 8.05415L4.44283 6.99945L3.3882 5.94482ZM5.18755 7.74451L7.00016 9.55701L8.81359 7.74365L9.86882 8.79776L9.8683 8.79832L7.00016 11.6663L4.13296 8.79914L4.13147 8.79765L5.18755 7.74451ZM10.6122 5.94542L9.5575 7.00012L10.6122 8.05475L11.6668 7.00005L10.6122 5.94542Z" fill="white" />
                  <path d="M8.06963 6.99988H8.07008L6.99996 5.92969L6.20898 6.72044L6.11811 6.81135L5.93069 6.9988L5.9292 7.00026L5.93069 7.00179L6.99996 8.0712L8.07015 7.001L8.07068 7.00041L8.06971 6.99988" fill="white" />
                </>
              );
            }
            ...
            if (shape === 'user-busd') {
              return (
                <>
                  <path d="M7.97768 1L9.70703 2.77102L5.3524 7.12565L3.62305 5.3963L7.97768 1Z" fill="#F0B90B" stroke="#F0B90B" />
                  <path d="M10.603 3.62598L12.3323 5.397L5.3524 12.3769L3.62305 10.6476L10.603 3.62598Z" fill="#F0B90B" stroke="#F0B90B" />
                  <path d="M2.72935 6.24902L4.4587 8.02005L2.72935 9.7494L1 8.02005L2.72935 6.24902Z" fill="#F0B90B" stroke="#F0B90B" />
                  <path d="M13.2328 6.24902L14.9622 8.02005L7.98228 15L6.25293 13.2706L13.2328 6.24902Z" fill="#F0B90B" stroke="#F0B90B" />
                </>
              );
            }
            ...
            if (shape === 'user-adf') {
              return (
                <>
                  ...
                  <path d="M11.435 6.45724V7.56391H7.98167V10.1017H6.875V5.00391H7.98167V6.45724H11.435Z" fill="white" />
                  <path d="M11.4358 3.89648H7.98242V5.00315H11.4358V3.89648Z" fill="white" />
                  <path d="M4.30223 3.89648L2.56445 10.1009H3.66668L4.37779 7.5676H5.40001V4.99871H6.87556V3.89648H4.30223Z" fill="white" />
                </>
              );
            }

            if (shape === 'document-img') {
              return (
                <>
                  <path opacity="0.8" d="M26.0984 10.7695L19.8715 4.76228C19.6979 4.59487 19.4606 4.5 19.2147 4.5H6.92593C6.41377 4.5 6 4.899 6 5.39286V28.6071C6 29.101 6.41377 29.5 6.92593 29.5H25.4444C25.9566 29.5 26.3704 29.101 26.3704 28.6071V11.4001C26.3704 11.1629 26.272 10.9369 26.0984 10.7695ZM12.9444 13.9308C13.5839 13.9308 14.1019 14.4302 14.1019 15.0469C14.1019 15.6635 13.5839 16.1629 12.9444 16.1629C12.305 16.1629 11.787 15.6635 11.787 15.0469C11.787 14.4302 12.305 13.9308 12.9444 13.9308ZM21.5093 22.1339H10.8611C10.6672 22.1339 10.5602 21.9191 10.6788 21.774L13.5666 18.2249C13.5882 18.1982 13.6159 18.1766 13.6475 18.1618C13.679 18.147 13.7137 18.1392 13.7488 18.1392C13.784 18.1392 13.8186 18.147 13.8502 18.1618C13.8818 18.1766 13.9095 18.1982 13.9311 18.2249L15.1204 19.6869L17.3715 16.9191C17.3932 16.8924 17.4208 16.8708 17.4524 16.856C17.484 16.8412 17.5187 16.8334 17.5538 16.8334C17.589 16.8334 17.6236 16.8412 17.6552 16.856C17.6868 16.8708 17.7145 16.8924 17.7361 16.9191L21.6858 21.774C21.8102 21.9191 21.7002 22.1339 21.5093 22.1339Z" fill="url(#paint0_linear_915_30356)" />
                  <defs>
                    <linearGradient id="paint0_linear_915_30356" x1="16.1852" y1="4.5" x2="16.1852" y2="29.5" gradientUnits="userSpaceOnUse">
                      <stop stopColor="#6E4DFF" />
                      <stop offset="1" stopColor="#3614FF" />
                    </linearGradient>
                  </defs>
                </>
              );
            ...
            if (shape === 'document-img-disabled') {
              return (
                <>
                  <path opacity="0.4" d="M26.0984 10.2695L19.8715 4.26228C19.6979 4.09487 19.4606 4 19.2147 4H6.92593C6.41377 4 6 4.399 6 4.89286V28.1071C6 28.601 6.41377 29 6.92593 29H25.4444C25.9566 29 26.3704 28.601 26.3704 28.1071V10.9001C26.3704 10.6629 26.272 10.4369 26.0984 10.2695ZM12.9444 13.4308C13.5839 13.4308 14.1019 13.9302 14.1019 14.5469C14.1019 15.1635 13.5839 15.6629 12.9444 15.6629C12.305 15.6629 11.787 15.1635 11.787 14.5469C11.787 13.9302 12.305 13.4308 12.9444 13.4308ZM21.5093 21.6339H10.8611C10.6672 21.6339 10.5602 21.4191 10.6788 21.274L13.5666 17.7249C13.5882 17.6982 13.6159 17.6766 13.6475 17.6618C13.679 17.647 13.7137 17.6392 13.7488 17.6392C13.784 17.6392 13.8186 17.647 13.8502 17.6618C13.8818 17.6766 13.9095 17.6982 13.9311 17.7249L15.1204 19.1869L17.3715 16.4191C17.3932 16.3924 17.4208 16.3708 17.4524 16.356C17.484 16.3412 17.5187 16.3334 17.5538 16.3334C17.589 16.3334 17.6236 16.3412 17.6552 16.356C17.6868 16.3708 17.7145 16.3924 17.7361 16.4191L21.6858 21.274C21.8102 21.4191 21.7002 21.6339 21.5093 21.6339Z" fill="url(#paint0_linear_1707_23620)" />
                  <defs>
                  <linearGradient id="paint0_linear_1707_23620" x1="16.1852" y1="4" x2="16.1852" y2="29" gradientUnits="userSpaceOnUse">
            ...
            if (shape === 'gallery-archive') {
              return (
                <>
                  <path d="M14.9993 2.5H4.99935C3.15768 2.5 1.66602 3.99167 1.66602 5.83333C1.66602 7.06667 2.34102 8.125 3.33268 8.70833V15.8333C3.33268 16.75 4.08268 17.5 4.99935 17.5H14.9993C15.916 17.5 16.666 16.75 16.666 15.8333V8.70833C17.6577 8.13333 18.3327 7.06667 18.3327 5.83333C18.3327 3.99167 16.841 2.5 14.9993 2.5ZM15.8327 7.26667L14.9993 7.75V15.8333H4.99935V7.75833L4.17435 7.275C3.64935 6.95833 3.33268 6.425 3.33268 5.83333C3.33268 4.91667 4.08268 4.16667 4.99935 4.16667H14.9993C15.916 4.16667 16.666 4.91667 16.666 5.83333C16.666 6.425 16.3493 6.96667 15.8327 7.26667Z" fill="black" />
                  <path d="M10.591 7.74167C10.4243 7.58333 10.216 7.5 9.99935 7.5C9.78268 7.5 9.57435 7.58333 9.40768 7.74167L6.90768 10.2417C6.58268 10.5667 6.58268 11.0917 6.90768 11.4167L9.40768 13.9167C9.57435 14.0833 9.78268 14.1667 9.99935 14.1667C10.216 14.1667 10.4243 14.0833 10.591 13.925L13.091 11.425C13.416 11.1 13.416 10.575 13.091 10.25L10.591 7.74167ZM9.99935 12.15L8.67435 10.8333L9.99935 9.50833L11.3243 10.8333L9.99935 12.15Z" fill="black" />
                </>
              );
            }
